    ...
    /***/ 63: /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony default export */ var tab_navvue_type_script_lang_js_ = {
        ...
        methods: {
          scrollPrev: function scrollPrev() {
            var containerSize =
              this.$refs.navScroll['offset' + tab_navvue_type_script_lang_js_firstUpperCase(this.sizeName)];
          ...
          update: function update() {
            ...
            var containerSize =
              this.$refs.navScroll['offset' + tab_navvue_type_script_lang_js_firstUpperCase(sizeName)];
            var currentOffset = this.navOffset;
      ...
      /* harmony default export */ var tabsvue_type_script_lang_js_ = {
        ...
        render: function render(h) {
          ...
          var header = h('div', { class: ['el-tabs__header', 'is-' + tabPosition] }, [
            newButton,
            h('tab-nav', navData),
          ]);
