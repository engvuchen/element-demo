module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 49: /***/ function (module, exports) {
      module.exports = require('element-demo/lib/input-number');
    ...
    /***/ 62: /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      // EXTERNAL MODULE: external "element-demo/lib/input-number"
        ...
        return _c(
          ...
          [
            _c(
              ...
              [
                _c('span', { attrs: { slot: 'content' }, slot: 'content' }, [_vm._v(_vm._s(_vm.formatValue))]),
                _c('div', {
          ...
          stops: function stops() {
            ...
            if (this.range) {
              return result.filter(function (step) {
                return (
                  step < (100 * (_this3.minValue - _this3.min)) / (_this3.max - _this3.min) ||
                  step > (100 * (_this3.maxValue - _this3.min)) / (_this3.max - _this3.min)
                );
              });
            } else {
              return result.filter(function (step) {
