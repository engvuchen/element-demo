              ...
              h('tr', { class: 'el-descriptions-row' }, [
                row.map(function (item) {
                  ...
                  return h(
                    ...
                    (_h['class'] = ['el-descriptions-item__content', item.contentClassName]),
                    (_h.style = item.contentStyle),
                    (_h.attrs = {
          ...
          return h('tbody', [
            h('tr', { class: 'el-descriptions-row' }, [
              row.map(function (item) {
                ...
                return h('td', { class: 'el-descriptions-item', attrs: { colSpan: item.props.span } }, [
        ...
        methods: {
          ...
          getRows: function getRows() {
            ...
            var children = (this.$slots.default || []).filter(function (vnode) {
              return (
                vnode.tag && vnode.componentOptions && vnode.componentOptions.Ctor.options.name === 'ElDescriptionsItem'
              );
            });
          ...
          return h('div', { class: 'el-descriptions' }, [
            title || extra || $slots.title || $slots.extra
              ? h('div', { class: 'el-descriptions__header' }, [
                  h('div', { class: 'el-descriptions__title' }, [$slots.title ? $slots.title : title]),
                  h('div', { class: 'el-descriptions__extra' }, [$slots.extra ? $slots.extra : extra]),
                ])
              : null,
