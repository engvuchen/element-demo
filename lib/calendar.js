module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 24: /***/ function (module, exports) {
      module.exports = require('element-demo/lib/utils/date');
    ...
    /***/ 70: /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      var render = function () {
        ...
        return _c('div', { staticClass: 'el-calendar' }, [
          _c('div', { staticClass: 'el-calendar__header' }, [
            _c('div', { staticClass: 'el-calendar__title' }, [_vm._v('\n      ' + _vm._s(_vm.i18nDate) + '\n    ')]),
      ...
      // EXTERNAL MODULE: external "element-demo/lib/utils/date"
        ...
        computed: {
          ...
          rows: function rows() {
            ...
            if (this.isInRange) {
              ...
              var currentMonthRange = Object(date_util_['range'])(end.getDate() - start.getDate() + 1).map(function (
                _,
                index
              ) {
                return {
                    ...
                    [
                      row.map(function (cell, key) {
                        return h(
                          ...
                          [h('div', { class: 'el-calendar-day' }, [_this.cellRenderProxy(cell)])]
                        );
                      }),
                    ]
                  );
